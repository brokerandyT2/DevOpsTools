...
namespace x3squaredcircles.PipelineGate.Container.Services
{
    ...
    public class DocumentationService : IHostedService
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            _app.MapGet("/health", () => Results.Ok(new { status = "healthy", service = "pipeline-gate-controller" }));
            _app.MapGet("/", () => Results.Redirect("/docs"));
            _app.MapGet("/docs", () => Results.Content(ServeMarkdownAsHtml("Docs/readme.md", "Pipeline Gate Controller Documentation"), "text/html"));
