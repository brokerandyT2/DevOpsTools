...
namespace x3squaredcircles.MobileAdapter.Generator.Services
{
    ...
    public class LanguageAttributeService : IHostedService
    {
        ...
        {
            // This is a simple static HTML for navigation.
            return @"
<!DOCTYPE html>
<html>
...
<head>
    ...
    <style>
        ...
        pre {{ background-color: #f6f8fa; padding: 16px; overflow: auto; border-radius: 3px; white-space: pre-wrap; word-wrap: break-word; }}
    </style>
</head>
<body>
    <pre>{content}</pre>
