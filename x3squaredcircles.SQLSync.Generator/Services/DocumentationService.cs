...
namespace x3squaredcircles.SQLSync.Generator.Services
{
    ...
    public class DocumentationService : IHostedService
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            _app.MapGet("/health", () => Results.Ok(new { status = "healthy", service = "sql-schema-generator" }));
            _app.MapGet("/", () => Results.Redirect("/docs"));
            _app.MapGet("/docs", () => Results.Content(ServeMarkdownAsHtml("Docs/readme.md", "SQL Schema Generator Documentation"), "text/html"));
...
<head>
    ...
    <style>
        ...
        pre {{ background-color: #f6f8fa; padding: 16px; overflow: auto; border-radius: 6px; white-space: pre-wrap; font-family: 'SFMono-Regular', Consolas, monospace; }}
